...
angles (with equal arcs, etc.) and lengths (equal radii, Ptolemy, etc.)

Circles can be constructed with rotated angles, therefore nearly any rotation will [generate circles](../Rotation/Basic%20Rotation.md#properties).
